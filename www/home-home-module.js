...
var HomePage = /** @class */ (function () {
    function HomePage(platform, alertController, _serviceIcoeur, loadingController, menuCtrl, router, popoverController) {
        var _this = this;
        ...
        this.nom = "";
        this.platform.backButton.subscribeWithPriority(11, function () {
            _this.deconnexion();
        });
    }
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                    ...
                                    cssClass: 'success',
                                    handler: function () {
                                        _this._serviceIcoeur.logout(JSON.parse(localStorage.getItem('currentUser')).login).then(function (access) {
                                            console.log(access);
    ...
    HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _services_i_coeur_service_service__WEBPACK_IMPORTED_MODULE_5__["ICoeurServiceService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["PopoverController"]])
    ], HomePage);
    return HomePage;
}());
