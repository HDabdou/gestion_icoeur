...
var FirstLogPage = /** @class */ (function () {
    ...
    FirstLogPage.prototype.valider = function () {
        ...
        if (this.newPassword == this.confirmNewPassword) {
            this._serviceIcoeur.firstLog({ newPassword: js_sha1__WEBPACK_IMPORTED_MODULE_4__(this.newPassword), oldPassword: js_sha1__WEBPACK_IMPORTED_MODULE_4__(this.oldPassword), id: JSON.parse(localStorage.getItem('currentUser')).id }).then(function (res) {
                if (res['status'] == true) {
